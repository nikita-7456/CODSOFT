...
if __name__=="__main__":
    ...
    gui.geometry("276x320")
    equation = StringVar()
    expression_field = Entry(gui, textvariable=equation, font="lucida 22 bold")
    expression_field.grid(columnspan=8)
    print()
    ...
    clear = Button(gui, text='Clear', fg='black', bg='grey',
                   command=clear, height=3, width=36)
    clear.grid(row=6, column = 0,rowspan=1, columnspan = 4)
